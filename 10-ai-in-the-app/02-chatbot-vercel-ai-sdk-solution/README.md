# Chatbot mit Vercel AI SDK (Musterlösung)
...
Öffne http://localhost:3032. Starte den Katalog separat in `../../01-mock-api` auf Port 4040. Provider und Key aus der lokalen `.env` werden nur für echte Chat-Anfragen benötigt. Gültige Demo-Konten: `restaurant-baeren`, `hotel-alpenblick`, `kantine-campus`.
...
Aufgabenstellung: [Starter](../02-chatbot-vercel-ai-sdk/EXERCISE.md). Alle Übungsschritte sind implementiert.
